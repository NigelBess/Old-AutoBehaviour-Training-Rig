...
%mouseID: char
%sessionNum: unique int
%numTrials: int, how many trials you want to run this session
%isTest: bool
    %try 
        if isTest
        ...
        for i = 1:numTrials
            ...
            %}
            initPos = [.5*e.xScreenCenter-stimSize(1)+1+isRight, e.yScreenCenter-stimSize(1)+1, .5*e.xScreenCenter+stimSize(1)+isRight, e.yScreenCenter+stimSize(2)];
