...
%abstract base class for RealExperiment and DummyExperiment
    ...
    methods
        function Setup(obj,id, num)
            ...
            obj.saveDir = strcat(pwd,'\Data', obj.mouseID, '_', obj.sessionID);%pwd is a builtin matlab variable for current path
            mkdir(obj.saveDir);
